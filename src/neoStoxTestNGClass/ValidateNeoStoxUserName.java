...
public class ValidateNeoStoxUserName extends Base
{
	...
	public void signIntoNeostox() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		password1.EnterPassword(Utility.readDataFromExcel(0, 1));
		Thread.sleep(500);
  ...
  {
	 // Assert.fail();
	  Assert.assertEquals(dashboard.getActualUserName(),Utility.readDataFromExcel(0, 2) ,"Actual and Expected usernames are not matching, TC is failed");
